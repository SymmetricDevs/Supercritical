...
public class ElementMaterials {
    ...
    public static void register() {
        Uranium = new Material.Builder(131, scId("uranium"))
                .ingot(3)
        ...
        Uranium239 = new Material.Builder(132, scId("uranium_239"))
                .color(0x46FA46).iconSet(SHINY)
                .element(SCElements.U239)
                .build();

        Neptunium235 = new Material.Builder(133, scId("neptunium_235"))
                .color(0x284D7B).iconSet(METALLIC)
                .element(SCElements.Np235)
                .build();

        Neptunium236 = new Material.Builder(134, scId("neptunium_236"))
                .color(0x284D7B).iconSet(METALLIC)
                .element(SCElements.Np236)
                .build();

        Neptunium237 = new Material.Builder(135, scId("neptunium_237"))
                .color(0x284D7B).iconSet(METALLIC)
                .element(SCElements.Np237)
                .build();

        Neptunium239 = new Material.Builder(136, scId("neptunium_239"))
                .color(0x284D7B).iconSet(METALLIC)
                .element(SCElements.Np239)
                .build();

        Plutonium238 = new Material.Builder(137, scId("plutonium_238"))
                .liquid(new FluidBuilder().temperature(913))
                .color(0xF03232).iconSet(METALLIC)
                .element(SCElements.Pu238)
                .build();

        Plutonium240 = new Material.Builder(138, scId("plutonium_240"))
                .liquid(new FluidBuilder().temperature(913))
                .color(0xF03232).iconSet(METALLIC)
                .element(SCElements.Pu240)
                .build();

        Plutonium242 = new Material.Builder(139, scId("plutonium_242"))
                .liquid(new FluidBuilder().temperature(913))
                .color(0xF03232).iconSet(METALLIC)
                .element(SCElements.Pu242)
                .build();

        Plutonium244 = new Material.Builder(140, scId("plutonium_244"))
                .liquid(new FluidBuilder().temperature(913))
                .color(0xF03232).iconSet(METALLIC)
                .element(SCElements.Pu244)
                .build();

        Plutonium = new Material.Builder(141, scId("plutonium"))
                .color(0xF03232).iconSet(METALLIC)
                .element(Elements.Pu)
                .build();
    }
