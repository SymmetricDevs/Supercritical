...
public class BlockPanelling extends VariantBlock<BlockPanelling.PanellingType> {
	...
	public enum PanellingType implements IStringSerializable {
		...
		WHITE("white"), ORANGE("orange"), MAGENTA("magenta"), LIGHT_BLUE("light_blue"), YELLOW("yellow"), LIME(
				"lime"), PINK("pink"), GRAY("gray"), LIGHT_GRAY("light_gray"), CYAN("cyan"), PURPLE(
						"purple"), BLUE("blue"), BROWN("brown"), GREEN("green"), RED("red"), BLACK("black");
