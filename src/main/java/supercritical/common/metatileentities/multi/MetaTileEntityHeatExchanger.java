...
public class MetaTileEntityHeatExchanger extends RecipeMapMultiblockController {
    ...
    protected @NotNull BlockPattern createStructurePattern() {
        return FactoryBlockPattern.start().aisle("CCC", "BCB", "ACA").aisle("CCC", "CDC", "ACA").setRepeatable(7)
                .aisle("CCC", "BSB", "AEA").where('S', selfPredicate()).where('A', frames(Materials.Steel))
                .where('B',
