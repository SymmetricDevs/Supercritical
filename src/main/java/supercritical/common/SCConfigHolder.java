...
public class SCConfigHolder {
    ...
    public static class MiscOptions {
        ...
        @Comment({ "Do material modifications, like adding flags or properties.",
                "Modpack devs might want to disable this to reduce conflicts.", "Default: true" })
        ...
        @Comment({ "Make auto-filled fluid block showup in the JEI / in-world preview.", "Default: false" })
        @RequiresMcRestart
        ...
        @Comment({ "The Starting Id for all Scrit MTEs",
                "Use with CAUTION since this could void Scrit MTEs in existing saves!", "Default: 0" })
        @RequiresMcRestart
