...
public interface ICoolantStats {
    ...
    /**
     * @return A factor relating to the neutron moderation properties; the higher
     *         the factor, the more fast neutrons are converted to slow neutrons.
     */
    double getModeratorFactor();

    /**
     * @return A factor relating to the neutron absorption properties; the higher
     *         the factor, the more slow neutrons are absorbed.
     */
    double getSlowAbsorptionFactor();

    /**
     * @return A factor relating to the neutron absorption properties; the higher
     *         the factor, the more fast neutrons are absorbed.
     */
    ...
    /**
     * @return If the coolant reacts with zirconium cladding at high temperatures.
     *         This is true for mostly water-based coolants.
     */
