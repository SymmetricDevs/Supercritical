...
public class ControlRod extends ReactorComponent {
    ...
    /**
     * Normalizes the weights of a list of control rods based on the true number of
     * fuel rod pairs.
     *
     * @param effectiveControlRods
     *                             The control rods to normalize.
     * @param totalWeight
     *                             The current total control rod weight.
     * @param totalWorth
     *                             The total control rod worth (what totalWeight *should* be).
     */
    ...
    /**
     * Determines the effect of a list of control rods based on how far they are
     * inserted into a reactor.
     *
     * @param effectiveControlRods
     *                             The list of control rods to be analyzed.
     * @param insertion
     *                             How far the control rods are inserted into the reactor, from 0 to
     *                             1.
     * @return A number representing the reactivity change of the reactor from the
     *         control rods.
     */
    ...
    /**
     * Notify the control rod of a pair of fuel rods that it is in the way of, to
     * help increase its weight later.
     */
    ...
    /**
     * @return Whether the control rod increases reactivity at low insertion levels
     *         (due to having a moderating tip).
     */
    ...
    /**
     * Automatically calculates the control rod weight (its effect on reactivity)
     * based on the number of fuel rod pairs that it is in the way of.
     */
