...
public class CoolantRegistry {
    ...
    @Nullable public static ICoolantStats getCoolant(Fluid fluid) {
        return COOLANTS.get(fluid);
    }

    @NotNull public static Collection<Fluid> getAllCoolants() {
        return COOLANTS.keySet();
    }

    @Nullable public static Fluid originalFluid(ICoolantStats stats) {
