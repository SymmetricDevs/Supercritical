...
public class SCMaterials {
	 ...
	 * Materials.EnrichedUraniumHexafluoride;
	 */
	...
	public static void register() {
		/*
		 * Registers Curium with id 0. Essential for reactor meltdown.
		 */
		Corium = new Material.Builder(0, scId("corium"))
				.liquid(new FluidBuilder().temperature(2500).density(8.0D).viscosity(10000)).color(0x7A6B50)
				.iconSet(DULL).flags(NO_UNIFICATION, STICKY, GLOWING).build();

		if (SCConfigHolder.misc.disableAllMaterials)
			return;
