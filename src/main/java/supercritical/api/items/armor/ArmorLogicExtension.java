...
/// An interface for radiation resistance implementation in
/// [IArmorLogic]. Implement this in your armor logic class and override the
/// default value to apply the resistance. Also see
/// [MixinIArmorLogic] and [MixinMetaPrefixItem].
