...
public class CoolantInfo implements IRecipeWrapper {
    ...
    public CoolantInfo(Fluid coolant, Fluid hotCoolant) {
        ...
        temps = I18n.format("supercritical.coolant.exit_temp", stats.getHotCoolant().getTemperature());
        heatCapacity = I18n.format("supercritical.coolant.heat_capacity", stats.getSpecificHeatCapacity());
        heatTransfer = I18n.format(I18n.format("supercritical.coolant.cooling_factor", stats.getCoolingFactor()));
        moderation = I18n.format("supercritical.coolant.moderation_factor", stats.getModeratorFactor());
