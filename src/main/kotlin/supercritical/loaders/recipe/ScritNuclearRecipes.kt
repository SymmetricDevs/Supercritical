...
object ScritNuclearRecipes {
    ...
    private fun gasCentrifugeRecipes() {
        ScritRecipeUtils.addRecipe(
            ScritRecipeMaps.GAS_CENTRIFUGE_RECIPES,
            ScritRecipeMaps.GAS_CENTRIFUGE_RECIPES.recipeBuilder("uranium_hexafluoride_enrichment")
        ...
        ScritRecipeUtils.addRecipe(
            ScritRecipeMaps.GAS_CENTRIFUGE_RECIPES,
            ScritRecipeMaps.GAS_CENTRIFUGE_RECIPES.recipeBuilder("enriched_uranium_hexafluoride_enrichment")
