...
object ScritNuclearRecipes {
    ...
    private fun gasCentrifugeRecipes() {
        ScritRecipeUtils.addRecipe(
            ScritRecipeTypes.GAS_CENTRIFUGE_RECIPES,
            ScritRecipeTypes.GAS_CENTRIFUGE_RECIPES.recipeBuilder("uranium_hexafluoride_enrichment")
        ...
        ScritRecipeUtils.addRecipe(
            ScritRecipeTypes.GAS_CENTRIFUGE_RECIPES,
            ScritRecipeTypes.GAS_CENTRIFUGE_RECIPES.recipeBuilder("enriched_uranium_hexafluoride_enrichment")
                .inputFluids(GTMaterials.EnrichedUraniumHexafluoride.getFluid(1000))
                .outputFluids(
                    ScritMaterials.HighEnrichedUraniumHexafluoride.getFluid(100),
                    GTMaterials.DepletedUraniumHexafluoride.getFluid(900)
                )
                .duration(800).EUt(GTValues.VA[GTValues.HV].toLong())
                .buildRawRecipe()
    ...
    private fun fuelReprocessing(
        ...
        ScritRecipeUtils.addRecipe(
            ...
            GTRecipeTypes.ELECTROLYZER_RECIPES.recipeBuilder(id + "_electrolytic_reprocessing")
                ...
                .inputItems(ScritOrePrefix.fuelPelletDepleted, material)
                .outputItems(ScritOrePrefix.dustSpentFuel, material)
                .outputItems(ScritOrePrefix.dustBredFuel, material)
                .chancedOutput(ScritOrePrefix.dustFissionByproduct, material, fissionByproductChance, 0)
        ...
        ScritRecipeUtils.addRecipe(
            ...
            GTRecipeTypes.CHEMICAL_RECIPES.recipeBuilder(id + "_spent_fuel_fluorination")
                .inputItems(ScritOrePrefix.dustSpentFuel, material)
        ...
        val bred = GTRecipeTypes.CENTRIFUGE_RECIPES.recipeBuilder(id + "_bred_fuel_centrifuging")
            .inputItems(ScritOrePrefix.dustBredFuel, material)
            .duration(200).EUt(GTValues.VA[GTValues.LV].toLong())
        if (bredChances[0] > 0) bred.chancedOutput(TagPrefix.dust, GTMaterials.Plutonium239, bredChances[0], 0)
        if (bredChances[1] > 0) bred.chancedOutput(TagPrefix.dust, ScritMaterials.Plutonium240, bredChances[1], 0)
        if (bredChances[2] > 0) bred.chancedOutput(TagPrefix.dust, GTMaterials.Plutonium241, bredChances[2], 0)
        if ("high_grade_mox" == id) bred.chancedOutput(TagPrefix.dust, ScritMaterials.Plutonium242, 59, 0)
        bred.chancedOutput(TagPrefix.dust, ScritMaterials.Neptunium239, bredChances[3], 0)
        ScritRecipeUtils.addRecipe(GTRecipeTypes.CENTRIFUGE_RECIPES, bred.buildRawRecipe())

        val fission = GTRecipeTypes.CENTRIFUGE_RECIPES.recipeBuilder(id + "_fission_byproduct_centrifuging")
            .inputItems(ScritOrePrefix.dustFissionByproduct, material)
            .duration(200).EUt(GTValues.VA[GTValues.LV].toLong())
        var i = 0
        ...
        ScritRecipeUtils.addRecipe(GTRecipeTypes.CENTRIFUGE_RECIPES, fission.buildRawRecipe())
    }
    ...
    private fun radonRecipes() {
        ScritRecipeUtils.addRecipe(
            ...
            GTRecipeTypes.CHEMICAL_BATH_RECIPES.recipeBuilder("radon_rich_gas_from_uraninite")
                ...
                .outputFluids(ScritMaterials.RadonRichGasMixture.getFluid(1000))
                .duration(200).EUt(GTValues.VA[GTValues.LV].toLong())
                .buildRawRecipe()
        )
        ...
        ScritRecipeUtils.addRecipe(
            ...
            GTRecipeTypes.CHEMICAL_BATH_RECIPES.recipeBuilder("radon_rich_gas_from_pitchblende")
                ...
                .outputFluids(ScritMaterials.RadonRichGasMixture.getFluid(1500))
                .duration(200).EUt(GTValues.VA[GTValues.LV].toLong())
                .buildRawRecipe()
        )
        ...
        ScritRecipeUtils.addRecipe(
            ...
            GTRecipeTypes.DISTILLATION_RECIPES.recipeBuilder("radon_rich_gas_mixture_distillation")
                .inputFluids(ScritMaterials.RadonRichGasMixture.getFluid(3000))
