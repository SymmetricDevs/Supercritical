 ...
 * Runs only from [io.github.symmetricdevs.supercritical.api.fission.reactor.ReactorCore.precompute].
 *
 * Reads fuel/control-rod data from the [io.github.symmetricdevs.supercritical.api.fission.ecs.resources.ReactorGeometryCache]
...
class NeutronicsPrecomputeSystem : System {
    ...
    // ----- control-rod worth (ported from PWRCore.computeControlRodWeights + ControlRod) -----
