...
import io.github.symmetricdevs.supercritical.api.fission.ecs.System
...
import io.github.symmetricdevs.supercritical.api.fission.ecs.query
...
class GeometryRebuildSystem : System {
    override fun update(world: World, dt: Double) {
        ...
        populateRowMajor<io.github.symmetricdevs.supercritical.api.fission.ecs.components.FuelRodComponent>(world, cache.fuelRods)
        populateRowMajor<io.github.symmetricdevs.supercritical.api.fission.ecs.components.ControlRodComponent>(world, cache.controlRods)
        populateRowMajor<io.github.symmetricdevs.supercritical.api.fission.ecs.components.CoolantChannelComponent>(world, cache.coolantChannels)
    }
}
