package io.github.symmetricdevs.supercritical.config
 ...
 *
 * `init()` is invoked early in mod construction (see [io.github.symmetricdevs.supercritical.Supercritical]) so that
