 ...
 * `dev.symmetric.supercritical.common.blocks.BlockMoltenCorium` (which extended GTCEu's `GTFluidBlock`):
 *
...
class MoltenCorium(
    ...
    override fun randomTick(state: BlockState, level: ServerLevel, pos: BlockPos, random: RandomSource) {
        ...
        if (!level.gameRules.getBoolean(GameRules.RULE_DOFIRETICK)) return
